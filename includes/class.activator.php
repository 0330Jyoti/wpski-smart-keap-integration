...
class WPSKI_Smart_Keap_Activator

{
    ...
    public function activate() {
		...
		$sql = "CREATE TABLE IF NOT EXISTS $smart_Keap_report_table_name (
		...
		$sql = "CREATE TABLE IF NOT EXISTS $smart_Keap_field_mapping_table_name (
			...
			Keap_module 		varchar(100) 	NOT NULL,

			Keap_field 			varchar(100) 	NOT NULL,
