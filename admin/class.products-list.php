...
class Product_Listk extends WP_List_Table {
	...
	public function no_items() {
		...
		echo esc_html__( 'No products avaliable.', 'wpski-smart-Keap' );
	...
	function get_columns() {
		...
		$columns = [
			...
			'ID'    => esc_html__( 'Product Id', 'wpski-smart-Keap' ),

			'post_title'    => esc_html__( 'Product Name', 'wpski-smart-Keap' ),

			'meta_value'    => esc_html__( 'Sku', 'wpski-smart-Keap' ),
